...
const Vision = () => {
  ...
  return (
    <div className=' flex flex-col justify-center md:flex-row items-center gap-20 mt-16 mx-5 lg:mx-32 '>
       <div className='w-full md:w-2/5'>
       <img src={require('../../assets/img/vision.jpg')}  className='rounded-lg'/>
       </div>
       <div className='w-full md:w-2/4  space-y-5'><h1 className='text-4xl font-bold'>Our Vision</h1>
